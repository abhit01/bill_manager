...
<body>
  ...
  <li style="float:right"><a class="navbar-brand" href="main.php">Web Sign-In</a></li></a></li></ul><br>
	...
	<h1 align="center"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Create A Customer Account</strong></h1>

	
		<div>	
		<table border=1 align="center">
		<form name="form" action="customer_register.php" method="post" onsubmit="return matchpass()">
			...
			<tr><td><input type="submit" value="submit"> <input type="reset"></td></tr>
  			...
  			<tr><td>Already a member? <a href="customerlogin.php">Sign in</a></td></tr>
